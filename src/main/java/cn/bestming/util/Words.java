...
public class Words {
	...
	public static interface WordCaseDescriptor {
		 ...
		 */
		CharConverter.CharCase getCharCase(Segment seg, int charIndex, boolean[] continueFlagRef);

		default void formatWord(final StringBuilder sb, final Segment seg, final CharConverter.CharCase preprocessor) {
