...
public class EasyDate implements Comparable<Object>, Cloneable, Serializable {
	 ...
	 * 例如，当前时间为：2021-10-10 例如要创建一个2021-10-10的时间对象，new EasyDate(null, 1, 0, 0)即可;<br>
	 * 创建一个2021-8-10的时间对象，new EasyDate(null, -1, -2, 0)或new EasyDate(null, 0, -14, 0)
	 *
	 * @param date 指定的时间，作为偏移量的参考对象，如果为null，则默认使用当前时间作为参考对象<br>
	 * 该对象支持java.util.Date、cn.bestming.util.EasyDate、java.util. Calendar等对象及其子类实例
	 ...
	 *
	 * @param date 指定的时间，作为偏移量的参考对象，如果为null，则默认使用当前时间作为参考对象<br>
	 * 该对象支持{@link java.util.Date}、{@link EasyDate}、 {@link java.util.Calendar}等对象及其子类实例
	 * @param offsetYear 相对于当前时间的年份偏移量
	 * @param offsetMonth 相对于当前时间的月份偏移量
	 * @param offsetDay 相对于当前时间的日期偏移量
	 */
	...
	/**
	 * 追加指定的年数，例如：当前年是2021，调用addYear(2)，则年份为2021
	 *
	...
	/**
	 * 追加指定的月数，例如：当前是2021-05-12，调用addMonth(2)，则为2021-07-12
	 *
	...
	/**
	 * 追加指定的天数，例如：当前是2021-05-12，调用addDay(2)，则为2021-05-14
	 *
	...
	/**
	 * 追加指定的小时数，例如：当前是2021-05-12 12:12:56，调用addHour(3)，则为2021-05-12 15:12:56
	 *
	...
	/**
	 * 追加指定的分钟数，例如：当前是2021-05-12 09:12:56，调用addMinute(3)，则为2021-05-12 09:15:56
	 *
	...
	/**
	 * 追加指定的秒数，例如：当前是2021-05-12 09:12:56 123，调用addMillisecond(123)，则为2021-05-12 09:12:56 246
	 *
	...
	/**
	 * 追加指定的秒数，例如：当前是2021-05-12 09:12:56，调用addSecond(3)，则为2021-05-12 09:12:59
	 *
	 ...
	 * 6=202106(年月)<br>
	 * 8=20210126(年月日)<br>
	 * 10=2021-01-02(年-月-日)<br>
	 * 19=2021-01-02 13:22:56(年-月-日 时:分:秒)
	 */
	...
	/**
	 * 返回GMT标准格式的字符串，例如：1 Dec 2021 15:05:00 GMT
	 */
	...
	/**
	 * 返回Internet GMT标准格式的字符串,例如：Sat, 1 Dec 2021 23:05:00 GMT
	 */
